...
Texas A\&M University & \textit{Work:} +1-518-395-7293 \\
337 Zachry Engineering Building            & \textit{Mobile:} +1-713-419-4198 \\
3133 TAMU           & \textit{E-mail:} \email{mhackemack@gmail.com}\\
College Station, TX  77843 USA    & \textit{WWW:}
\href{http://www.bmpc.com/}{bmpc.com}\\
\end{tabular}
...
%-------------------------------------------------------------------------------------------------------------------------------------------------
Department of Energy L Clearance (issued: 2011)
...
\item[] Ph.D., Nuclear Engineering, May 2015
        \begin{innerlist}
...
\item[] B.S., Nuclear Engineering, May 2011
        ...
        \item Research in Experimental Thermal Hydraulics
...
\begin{innerlist}
    ...
    \item[$\star$] \emph{Dr.~Ragusa was mydoctoral graduate adviser.}
\end{innerlist}
