...
\vspace{-.325cm}
\begin{bibsection}
\item \textbf{M.W. Hackemack}, ``Fixed-Point Acceleration of Nonlinear Spatial Discretizations,'' \textit{PHYSOR 2018: Reactors Physics paving the way towards more efficient systems}, Cancun, Mexico (In Review).

\item \textbf{M.W. Hackemack}, ``Quadratic Serendipity Functions for DGFEM Transport on 2D Polygonal and 3D Extruded Polygonal Grids,'' \textit{PHYSOR 2018: Reactors Physics paving the way towards more efficient systems}, Cancun, Mexico (In Review).

\item \textbf{M.W. Hackemack} and J.C. Ragusa, ``Quadratic Serendipity Discontinuous Finite Element Discretization
for $S_N$ Transport on Arbitrary Polygonal Grids,'' \textit{Journal of Computational Physics}, (In Review).
