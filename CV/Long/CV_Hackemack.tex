...
\item \textbf{M.W. Hackemack}, ``Spatial Adaptive Mesh Refinement Applied to the Slice Balance Approach,'' \textit{M\&C 2021 - International Conference on Mathematics \& Computational Methods Applied to Nuclear Science \& Engineering}, Rayleigh, NC (In Review).

\item \textbf{M.W. Hackemack}, ``Diffusion Synthetic Acceleration for Arbitrary-Order Discontinuous Finite Elements on Polygons,'' \textit{M\&C 2021 - International Conference on Mathematics \& Computational Methods Applied to Nuclear Science \& Engineering}, Rayleigh, NC (In Review).

\item \textbf{M.W. Hackemack}, ``Arbitrary-Level Hierarchical CMFD Acceleration for Diffusion Eigenvalue Problems,'' \textit{M\&C 2021 - International Conference on Mathematics \& Computational Methods Applied to Nuclear Science \& Engineering}, Rayleigh, NC (In Review).
