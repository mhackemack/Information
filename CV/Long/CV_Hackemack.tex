...
\vspace{-.325cm}
\begin{bibsection}
\item \textbf{M.W. Hackemack}, M. Hanus, and J.C. Ragusa, ``Quadratic Serendipity Functions for DGFEM Transport Solutions on Concave Polygonal Meshes,'' \textit{Transactions of the American Nuclear Society}, Orlando, Florida (In Preparation).
...
\item M.W. Hackemack, \textit{Generalized Barycentric Coordinates for Diffusive Transport Problems} (2017).
