...
\vspace{-.325cm}
\begin{bibsection}
\item \textbf{M.W. Hackemack}, ``The Slice Balance Approach Using an Adaptive-Weighted Closure,'' \textit{PHYSOR 2020: Transition to a Scalable Nuclear Future}, Cambridge, United Kingdom (In Review).

\item \textbf{M.W. Hackemack}, ``Arbitrary-Order Extruded Bernstein-Bezier Functions for DGFEM Transport on 3D Prismatic Polygonal Grids,'' \textit{PHYSOR 2020: Transition to a Scalable Nuclear Future}, Cambridge, United Kingdom (In Review).

\item \textbf{M.W. Hackemack}, ``Solving Nonlinear Discretizations of $S_N$ Transport Calculations,'' \textit{Annals of Nuclear Energy}, (In Review).
...
\vspace{-.325cm}
\begin{bibsection}
\item \textbf{M.W. Hackemack}, J.C. Ragusa, and J.E. Morel, ``Correcting the Boundary Inconsistencies in the Modified Interior Penalty Method,'' \textit{Nuclear Science and Engineering} (In Preparation).

\item \textbf{M.W. Hackemack}, S.J. Douglass, N. Gibson, and T.L. Becker, ``Modelling System for Reactor Analysis Calculations using 3D $S_N$ Transport,'' \textit{Annals of Nuclear Energy} (In Preparation).

\item \textbf{M.W. Hackemack} and T.L. Becker, ``Mulitlevel CMFD Acceleration with Hierarchical Coarsening in Space and Energy,'' \textit{Annals of Nuclear Energy} (In Preparation).

\item \textbf{M.W. Hackemack}, ``Aribtrary-Order Discontinuous Galerkin Discretization using Polygonal Bernstein-Bezier Functions for Elliptic Problems,'' \textit{Journal of Computational and Applied Mathematics} (In Preparation).
