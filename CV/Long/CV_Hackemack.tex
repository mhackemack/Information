...
\begin{innerlist}
\item[] Worked on a team to develop a multiphysics analysis tool system for nuclear reactor core design. Furthermore, worked more integrally on a team subset to develop the deterministic radiation transport solver Jaguar which provides high-fidelity, 3D, $S_N$ solutions at scale on many parallel processes. Took over as the Jaguar team lead in 2020.
\end{innerlist}
...
\item[] Design and teach topical courses on transport theory, reactor physics, and reactor design. Some of these courses satisfy graduate degree course requirements with collaborating universities.
...
\item \textbf{M.W. Hackemack}, ``Spatial Adaptive Mesh Refinement Applied to the Slice Balance Approach,'' \textit{M\&C 2021 - International Conference on Mathematics \& Computational Methods Applied to Nuclear Science \& Engineering}, Rayleigh, NC (Accepted).

\item \textbf{M.W. Hackemack}, ``Diffusion Synthetic Acceleration for Arbitrary-Order Discontinuous Finite Elements on Polygons,'' \textit{M\&C 2021 - International Conference on Mathematics \& Computational Methods Applied to Nuclear Science \& Engineering}, Rayleigh, NC (Accepted).

\item \textbf{M.W. Hackemack}, ``Arbitrary-Level Hierarchical CMFD Acceleration for Diffusion Eigenvalue Problems,'' \textit{M\&C 2021 - International Conference on Mathematics \& Computational Methods Applied to Nuclear Science \& Engineering}, Rayleigh, NC (Accepted).

\item \textbf{M.W. Hackemack}, ``Arbitrary-Order Finite Element Discretization of the Radiation Diffusion Equation on Polygonal Grids,'' \textit{Transactions of the American Nuclear Society}, Chicago, IL (Accepted).
...
\item \textbf{M.W. Hackemack}, T.L. Becker, and S.J. Douglass, ``Arbitrary-Level Coarse Mesh Finite Difference Acceleration with Hierarchical Coarsening in Space and Energy,'' \textit{Annals of Nuclear Energy}, \textbf{147} (2020).
