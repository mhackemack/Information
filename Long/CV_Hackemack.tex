...
\item M.W. Hackemack, J.C. Ragusa, D.P. Griesheimer, and J.M. Pounders, ``A Monte Carlo
	Implementation of the Predictor-Corrector Quasi-Static Method,'' 
	\textit{Mathematics and Computation}, Sun Valley, ID (2013).
...
\item M. Hanus, J.C. Ragusa, and M.W. Hackemack, \textit{Thermal Upscatter Acceleration Methods} (2017).
